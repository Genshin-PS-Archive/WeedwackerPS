...
namespace Weedwacker.GameServer.Commands.Definitions
{
    internal class SpawnCommandDefinition : ICommandDefinition
    {
        public static readonly Dictionary<uint, string> MonsterLookup = new()
        {
            ...
            [20012001] = string.Empty,
            [20012101] = string.Empty,
            [20012201] = string.Empty,
            ...
            [22070101] = string.Empty,
            [22070102] = string.Empty,
            [22070201] = string.Empty,
            [22070202] = string.Empty,
            [22070301] = string.Empty,
            [22070302] = string.Empty,
            [22080101] = string.Empty,
            [22090101] = string.Empty,
            [23010101] = string.Empty,
            [23010201] = string.Empty,
            [23010301] = string.Empty,
            [23010401] = string.Empty,
            [23010501] = string.Empty,
            [23010601] = string.Empty,
            [23020101] = "Fatui Agent",
            [23020102] = string.Empty,
            [23030101] = "Fatui Electro Cicin Mage",
            [23030102] = string.Empty,
            ...
            [24010108] = string.Empty,
            [24010109] = string.Empty,
            ...
            [24010304] = string.Empty,
            [24010401] = string.Empty,
            ...
            [24030101] = string.Empty,
            [24030201] = string.Empty,
            [24030301] = string.Empty,
            [24040101] = string.Empty,
            [24040201] = string.Empty,
            [24040301] = string.Empty,
            [24050101] = string.Empty,
            [25010101] = "Liuliu",
            [25010102] = "Mystery Man",
            [25010103] = string.Empty,
            [25010104] = string.Empty,
            [25010105] = string.Empty,
            [25010106] = string.Empty,
            [25010201] = "Treasure Hoarder Scout",
            [25010203] = string.Empty,
            [25010204] = string.Empty,
            [25010205] = string.Empty,
            [25010206] = string.Empty,
            [25010207] = string.Empty,
            [25010208] = string.Empty,
            [25010209] = string.Empty,
            [25010210] = string.Empty,
            [25010211] = string.Empty,
            [25010301] = string.Empty,
            [25010302] = string.Empty,
            [25010401] = string.Empty,
            [25010501] = string.Empty,
            [25010601] = string.Empty,
            [25010701] = string.Empty,
            [25020101] = "Raptor",
            [25020102] = string.Empty,
            [25020201] = "Treasure Hoarder Marksman",
            [25020204] = string.Empty,
            [25030101] = "Carmen",
            [25030102] = string.Empty,
            [25030103] = string.Empty,
            [25030201] = "Treasure Hoarder Gravedigger",
            [25030301] = "Treasure Hoarder Oarsman",
            [25040101] = "Boss",
            [25040102] = string.Empty,
            [25040103] = string.Empty,
            [25050101] = "Millelith Soldier",
            [25050201] = "Millelith Sergeant",
            [25050301] = "Shogunate Infantry",
            [25050401] = "Shogunate Infantry Captain",
            [25050402] = string.Empty,
            [25050501] = "Sangonomiya Cohort",
            [25050502] = string.Empty,
            [25060101] = string.Empty,
            [25060102] = string.Empty,
            [25070101] = string.Empty,
            [25070201] = string.Empty,
            [25070202] = string.Empty,
            [25080101] = "Ronin",
            [25080201] = "Ronin: Sanzoku",
            [25080202] = string.Empty,
            [25080301] = "Ronin: Anbu",
            [25080401] = "Shogunate Samurai",
            [25080402] = string.Empty,
            [25080403] = string.Empty,
            [25080404] = string.Empty,
            ...
            [25100102] = string.Empty,
            [25100201] = "Pyro Kairagi",
            [25100301] = "Thunderwraith Kairagi",
            [25100302] = string.Empty,
            [25100401] = "Flameghoul Kairagi",
            [25110101] = string.Empty,
            [25110102] = string.Empty,
            [25110201] = string.Empty,
            [25110202] = string.Empty,
            [25210101] = string.Empty,
            [25210102] = string.Empty,
            [25210103] = string.Empty,
            [25210104] = string.Empty,
            [25210105] = string.Empty,
            [25210106] = string.Empty,
            [25210107] = string.Empty,
            [25210108] = string.Empty,
            [25210201] = string.Empty,
            [25210202] = string.Empty,
            [25210203] = string.Empty,
            [25210204] = string.Empty,
            [25210205] = string.Empty,
            [25210206] = string.Empty,
            [25210207] = string.Empty,
            [25210208] = string.Empty,
            [25210209] = string.Empty,
            [25210301] = string.Empty,
            [25210302] = string.Empty,
            [25210303] = string.Empty,
            [25210304] = string.Empty,
            [25210305] = string.Empty,
            [25210306] = string.Empty,
            [25210307] = string.Empty,
            [25210401] = string.Empty,
            [25210402] = string.Empty,
            [25210403] = string.Empty,
            [25210404] = string.Empty,
            [25210405] = string.Empty,
            [25210406] = string.Empty,
            [25210407] = string.Empty,
            [25210501] = string.Empty,
            [25210502] = string.Empty,
            [25210503] = string.Empty,
            [25210504] = string.Empty,
            [25210505] = string.Empty,
            [25210506] = string.Empty,
            [25210507] = string.Empty,
            [25210601] = string.Empty,
            [25210602] = string.Empty,
            [25310101] = string.Empty,
            [25310201] = string.Empty,
            [25310202] = string.Empty,
            [25310301] = string.Empty,
            [25410101] = string.Empty,
            [25410201] = string.Empty,
            ...
            [26050601] = string.Empty,
            [26050701] = string.Empty,
            [26050702] = string.Empty,
            [26050801] = string.Empty,
            [26050802] = string.Empty,
            [26050901] = string.Empty,
            [26051001] = string.Empty,
            [26051101] = string.Empty,
            [26060101] = "Electro Cicin",
            [26060201] = "Hydro Cicin",
            [26060301] = "Cryo Cicin",
            [26080101] = string.Empty,
            [26090101] = string.Empty,
            [26090190] = string.Empty,
            [26090191] = string.Empty,
            [26090201] = string.Empty,
            [26090202] = string.Empty,
            [26090290] = string.Empty,
            [26090291] = string.Empty,
            [26090301] = string.Empty,
            [26090390] = string.Empty,
            [26090391] = string.Empty,
            [26090401] = string.Empty,
            [26090490] = string.Empty,
            [26090491] = string.Empty,
            [26090501] = string.Empty,
            [26090590] = string.Empty,
            [26090591] = string.Empty,
            [26090601] = string.Empty,
            [26090690] = string.Empty,
            [26090691] = string.Empty,
            [26090701] = string.Empty,
            [26090790] = string.Empty,
            [26090791] = string.Empty,
            [26090801] = string.Empty,
            [26090890] = string.Empty,
            [26090891] = string.Empty,
            [26090901] = string.Empty,
            [26090990] = string.Empty,
            [26090991] = string.Empty,
            [26091001] = string.Empty,
            [26091090] = string.Empty,
            [26091091] = string.Empty,
            [26110101] = string.Empty,
            [26120101] = string.Empty,
            [26120201] = string.Empty,
            [26120301] = string.Empty,
            [26120401] = string.Empty,
            ...
            [28010208] = string.Empty,
            [28010301] = "Frog",
            [28010302] = "Mud Frog",
            [28010303] = "Blue Frog",
            [28010304] = string.Empty,
            [28010401] = string.Empty,
            [28010402] = string.Empty,
            [28010403] = string.Empty,
            [28010404] = string.Empty,
            [28020101] = "Snow Fox",
            [28020102] = "Crimson Fox",
            [28020103] = "Gifting Snow Fox",
            [28020104] = "Super-Gifting Snow Fox",
            [28020105] = string.Empty,
            [28020106] = string.Empty,
            [28020107] = string.Empty,
            [28020108] = string.Empty,
            [28020201] = "Squirrel",
            ...
            [28020306] = string.Empty,
            [28020307] = string.Empty,
            [28020308] = string.Empty,
            [28020309] = string.Empty,
            [28020310] = string.Empty,
            [28020311] = string.Empty,
            [28020312] = string.Empty,
            [28020313] = string.Empty,
            [28020314] = string.Empty,
            [28020315] = string.Empty,
            ...
            [28020407] = string.Empty,
            [28020408] = string.Empty,
            [28020409] = string.Empty,
            [28020410] = string.Empty,
            [28020501] = "Sapphire",
            ...
            [28030312] = string.Empty,
            [28030313] = string.Empty,
            [28030401] = "Crimson Finch",
            [28030402] = "Golden Finch",
            [28030403] = "Snow Finch",
            [28030404] = "Emerald Finch",
            [28030405] = string.Empty,
            [28030406] = string.Empty,
            [28030407] = string.Empty,
            [28030408] = string.Empty,
            [28030409] = string.Empty,
            [28030501] = "Scarletbeak Duck",
            [28030502] = "Emerald Duck",
            [28030504] = string.Empty,
            [28030505] = string.Empty,
            ...
            [28040701] = string.Empty,
            [28040702] = string.Empty,
            [28040703] = string.Empty,
            [28040801] = string.Empty,
            [28040802] = string.Empty,
            [28040803] = string.Empty,
            [28040804] = string.Empty,
            [28040901] = string.Empty,
            [28040902] = string.Empty,
            [28050101] = "Anemo Crystalfly",
            [28050102] = "Geo Crystalfly",
            [28050103] = "Cryo Crystalfly",
            [28050104] = "Electro Crystalfly",
            [28050105] = string.Empty,
            [28050106] = string.Empty,
            [28050201] = "Amateur Weasel Thief",
            [28050202] = "Hoarder Weasel Thief",
            [28050203] = "Golden Weasel Thief",
            [28050204] = string.Empty,
            [28050211] = "Amateur Weasel Thief",
            [28050212] = "Hoarder Weasel Thief",
            [28050213] = "Golden Weasel Thief",
            [28050221] = string.Empty,
            [28050222] = string.Empty,
            [28050223] = string.Empty,
            [28050301] = string.Empty,
            [28050401] = string.Empty,
            [28060101] = string.Empty,
            [28060102] = string.Empty,
            [28060103] = string.Empty,
            [28060201] = string.Empty,
            [28060202] = string.Empty,
            [28060203] = string.Empty,
            [28060301] = string.Empty,
            [28060302] = string.Empty,
            [28060401] = string.Empty,
            [28060402] = string.Empty,
            [28060501] = string.Empty,
            [28060502] = string.Empty,
            [28060503] = string.Empty,
            [28060504] = string.Empty,
            [28060505] = string.Empty,
            [28060506] = string.Empty,
            [28060509] = string.Empty,
            [28060510] = string.Empty,
            [28060511] = string.Empty,
            [28060512] = string.Empty,
            [28060513] = string.Empty,
            [28060601] = string.Empty,
            [28060602] = string.Empty,
            [28060603] = string.Empty,
            [28060604] = string.Empty,
            [28060605] = string.Empty,
            [28060606] = string.Empty,
            [28060609] = string.Empty,
            [28060610] = string.Empty,
            [28060611] = string.Empty,
            [28060612] = string.Empty,
            [28060613] = string.Empty,
            [28060614] = string.Empty,
            [28060701] = string.Empty,
            [28060801] = string.Empty,
            [28060901] = string.Empty,
            [28061001] = string.Empty,
            [28061002] = string.Empty,
            [28061101] = string.Empty,
            [28061201] = string.Empty,
            [28061301] = string.Empty,
            [28061401] = string.Empty,
            [28061402] = string.Empty,
            ...
            [28240701] = string.Empty,
            [28240702] = string.Empty,
            [28240801] = string.Empty,
            [28240802] = string.Empty,
            [28240803] = string.Empty,
            [28240804] = string.Empty,
            [28240901] = string.Empty,
            [28240902] = string.Empty,
            ...
            [28250105] = string.Empty,
            [28250106] = string.Empty,
            [28250301] = string.Empty,
            [28250401] = string.Empty,
            ...
            [29060102] = "Raiden Ei",
            [29060201] = string.Empty,
            [29060202] = string.Empty,
            [29060203] = string.Empty,
            [29070101] = string.Empty,
            [29070102] = string.Empty,
            [29070103] = string.Empty,
            [29070104] = string.Empty,
            [29070105] = string.Empty,
            [35210101] = string.Empty,
            [35210102] = string.Empty,
            [35210301] = string.Empty,
            [35210302] = string.Empty,
            [35210303] = string.Empty,
            [35210401] = string.Empty,
            [35210501] = string.Empty,
            [35310101] = string.Empty,
            [35310301] = string.Empty,
            [36090190] = string.Empty,
            [36090290] = string.Empty,
            [36090390] = string.Empty,
            [36090490] = string.Empty,
            [36090590] = string.Empty,
            [36090690] = string.Empty,
            [36090790] = string.Empty,
            [36090890] = string.Empty,
            [36090990] = string.Empty,
            [36091090] = string.Empty,
        };

        private readonly Command _command;

        public SpawnCommandDefinition()
        {
        ...
        {
            RankedCommand spawn = new(UserRank.GM, "spawn", "Spawns various entities.");

            RankedCommand monster = new(UserRank.GM, "monster", "Spawns a monster at the players location.");
            Argument<uint> monsterUidArg = new("uid", "The UID of the player to spawn the monster at.");
            Argument<uint> monsterIdArg = new("id", "The ID of the monster to spawn. Use 'list monsters' for all monster ID's.");
            Argument<uint> monsterLevelArg = new("level", () => 1, "Optional. The level of the monster to spawn or 1.");
            monster.AddArgument(monsterUidArg);
            monster.AddArgument(monsterIdArg);
            monster.AddArgument(monsterLevelArg);
            monster.SetHandler(context => SpawnMonster(
                context.ParseResult.GetValueForArgument(monsterUidArg),
                context.ParseResult.GetValueForArgument(monsterIdArg),
                context.ParseResult.GetValueForArgument(monsterLevelArg),
                context.Console));

            spawn.AddCommand(monster);

            return spawn;
        }

        private void SpawnMonster(uint uid, uint id, uint level, IConsole output)
        {
            ...
            if (!GameData.MonsterDataMap.TryGetValue(id, out MonsterExcelConfig? monsterData))
            {
                output.WriteLine("MonsterId is unknown.");
                return;
            }

            try
            {
                MonsterEntity createdMonster = MonsterEntity.CreateAsync(playerConn.Player.Scene, playerConn.Player, monsterData, level).Result;
                playerConn.Player.Scene.AddEntityAsync(createdMonster).Wait();
            }
            catch
            {
                output.WriteLine("Monster could not be spawned.");
                return;
            }

            output.WriteLine("Monster spawned.");
        }
    }
}
