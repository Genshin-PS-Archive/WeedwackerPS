...
namespace Weedwacker.WebServer
{
    internal static class RegionManager
    {
        ...
        {
            WebConfig.KestrelJson? kestrel = WebServer.Configuration.Kestrel;
            ...
            configuredRegions.ForEach(region =>
                {
                    ...
                    RegionSimpleInfo? identifier = new()
                    {
                        Name = region.Name,
                        Title = region.Title,
                        Type = "DEV_PUBLIC",
                    ...
                    QueryCurrRegionHttpRsp? updatedQuery = new();
            ...
            QueryRegionListHttpRsp updatedRegionList = new();
