    ...
    internal class GetAnnList : IHandler
    {
        public class GetAnnListRspJson
        {
            ...
            public class Data
            {
                ...
                public Data(List<AnnList.Announcement> announcements)
                {
                    ...
                    type_list = new List<AnnType> { new AnnType(1, "活动公告", "Activity"), new AnnType(2, "游戏系统公告", "System"), new AnnType(3, "idklol", "Events") };
        ...
        public async Task<bool> HandleAsync(HttpContext context)
        {
            ...
            if (!File.Exists(WebServer.Configuration.structure.data + "GameAnnouncementList.json"))
            {
                ...
                data = new GetAnnListRspJson.Data(new List<GetAnnListRspJson.Data.AnnList.Announcement>() { ann1, ann2 });
